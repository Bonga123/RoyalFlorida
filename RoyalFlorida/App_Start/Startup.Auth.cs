...
namespace RoyalFlorida
{
    public partial class Startup
    {
        ...
        public void CreateUser()
        {
            ...
            user.UserName = "Admin@Royalflorida.com";
            user.Email = "Admin@Royalflorida.com";
            ...
            //  user.Email = "Admin@esolutions.com";
            // user.UserName = user.Email;
            user2.UserName = "Receptionist@Royalflorida.com";
            user2.Email = "Receptionist@Royalflorida.com";
